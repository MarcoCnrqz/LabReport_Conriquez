...
def generar_pdf_reporte(detalles):
    ...
    #
    # La columna OPCIONES muestra las opciones cualitativas cuando las hay
    # (POSITIVO/NEGATIVO, REACTIVO/NO REACTIVO, etc.).
    # Para resultados cuantitativos esa celda queda vacía o con guión.
    # =========================================================================
 
    # Proporciones de columnas sobre ANCHO_UTIL
    COL_PRUEBA  = ANCHO_UTIL * 0.27
    COL_RESULT  = ANCHO_UTIL * 0.15
    COL_REF     = ANCHO_UTIL * 0.18
    COL_UNIDAD  = ANCHO_UTIL * 0.12
    COL_OPCIONES = ANCHO_UTIL * 0.28   # Columna nueva para opciones cualitativas
    ...
    def dibujar_encabezados_tabla(yy):
        ...
        # Franja inferior del encabezado
        c.setFillColor(COLOR_SECUNDARIO)
    ...
    for i, res in enumerate(resultados):
        # ¿Cabe la fila o hay que saltar de página?
        ...
        if opciones_str:
            # Formatear: "POSITIVO,NEGATIVO" → "Pos / Neg" en gris pequeño
    ...
    # Línea separadora del footer con color primario
    c.setStrokeColor(COLOR_PRIMARIO)
    c.setLineWidth(1.2)
